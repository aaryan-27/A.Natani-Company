...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Yogendra Jain & Company, a trusted Chartered Accountant firm in Jaipur. Our mission, values and the expertise behind our tax, GST and compliance services.",
          ...
          <Reveal>
            ...
            <div className="mt-5 space-y-4 text-muted leading-relaxed">
              <p>
                ...
                business advisory firm based in Bani Park, Jaipur. We bring
      ...
      <Section tone="white">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
              ...
              <div className="aspect-[4/5] overflow-hidden rounded-3xl bg-gradient-to-br from-navy to-royal-600 p-1">
                <div className="grid h-full w-full place-items-center rounded-[1.4rem] bg-navy text-white">
                  <div className="text-center">
                    ...
                    <p className="mt-5 font-heading text-xl font-bold">CA Yogendra Jain</p>
          ...
          <Reveal delay={1} className="lg:col-span-7">
            ...
            <h2 className="mt-4 font-heading text-3xl font-bold text-navy">CA Yogendra Jain</h2>
            <p className="mt-4 leading-relaxed text-muted">
              A qualified Chartered Accountant with over a decade of experience
              advising individuals, startups and growing businesses, CA Yogendra
              Jain founded the firm with a simple belief: every client deserves
              honest, accessible and expert financial guidance.
            </p>
